        ...
        <>
          ...
          <div className="absolute right-0 z-50 mt-2 w-56 overflow-hidden rounded-lg border bg-surface-2 shadow-lg">
            ...
            <Link
              ...
              className="flex items-center gap-3 px-3 py-2 text-sm text-ink transition-colors hover:bg-[color:var(--accent)]"
            >
            ...
            <form action={signOut}>
              <button
                type="submit"
                className="flex w-full items-center gap-3 px-3 py-2 text-left text-sm text-ink transition-colors hover:bg-[color:var(--accent)]"
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" aria-hidden>
